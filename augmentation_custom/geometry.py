...
class Rotate:
    def __init__(self, square_side=448, rng=None):
    ...
    def __call__(self, img, iscurve=False, mag=-1, prob=1.):
        ...
        angle = self.rng.uniform(-rotate_angle, rotate_angle)
        if self.rng.uniform(0, 1) < 0.5:
            angle = -angle
...
if __name__ == "__main__":
    ...
    for i in range(0,100):
        augmented_img_1 = pers(img, margin, prob)
        augmented_img_1.save("./result/aug_img{}.png".format(i))

    #using Shrink, Rotate, Perspective